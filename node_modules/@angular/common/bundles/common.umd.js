...
!function (global, factory) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? factory(exports, require("@angular/core")) : "function" == typeof define && define.amd ? define(["exports", "@angular/core"], factory) : factory((global.ng = global.ng || {}, global.ng.common = global.ng.common || {}), global.ng.core);
}(undefined, function (exports, _angular_core) {
  "use strict";
  function getTypeNameForDebugging(type) {
    ...
    return (_a = Object).assign.apply(_a, [{}].concat(options));var _a;
    ...
    var fn = PATTERN_ALIASES[format];if (fn) return fn(date, locale);var cacheKey = format,
      ...
      parts = [];var match = void 0;for (DATE_FORMATS_SPLIT.exec(format); format;) {
        match = DATE_FORMATS_SPLIT.exec(format), match ? (parts = parts.concat(match.slice(1)), format = parts.pop()) : (parts.push(format), format = null);
    ...
    if (void 0 === currency && (currency = null), void 0 === currencyAsSymbol && (currencyAsSymbol = !1), isBlank(value)) return null;if (value = "string" == typeof value && NumberWrapper.isNumeric(value) ? +value : value, "number" != typeof value) throw new InvalidPipeArgumentError(pipe, value);var minInt, minFraction, maxFraction;if (style !== NumberFormatStyle.Currency && (minInt = 1, minFraction = 0, maxFraction = 3), digits) {
    ...
    function PlatformLocation() {}return PlatformLocation.prototype.getBaseHrefFromDOM = function () {}, PlatformLocation.prototype.onPopState = function (fn) {}, PlatformLocation.prototype.onHashChange = function (fn) {}, Object.defineProperty(PlatformLocation.prototype, "pathname", { get: function get() {
        return null;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(PlatformLocation.prototype, "search", { get: function get() {
        return null;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(PlatformLocation.prototype, "hash", { get: function get() {
        return null;
      }, enumerable: !0, configurable: !0 }), PlatformLocation.prototype.replaceState = function (state, title, url) {}, PlatformLocation.prototype.pushState = function (state, title, url) {}, PlatformLocation.prototype.forward = function () {}, PlatformLocation.prototype.back = function () {}, PlatformLocation;
  }(),
    ...
    function LocationStrategy() {}return LocationStrategy.prototype.path = function (includeHash) {}, LocationStrategy.prototype.prepareExternalUrl = function (internal) {}, LocationStrategy.prototype.pushState = function (state, title, url, queryParams) {}, LocationStrategy.prototype.replaceState = function (state, title, url, queryParams) {}, LocationStrategy.prototype.forward = function () {}, LocationStrategy.prototype.back = function () {}, LocationStrategy.prototype.onPopState = function (fn) {}, LocationStrategy.prototype.getBaseHref = function () {}, LocationStrategy;
      ...
      APP_BASE_HREF = new _angular_core.OpaqueToken("appBaseHref");globalScope = "undefined" == typeof window ? "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : global : window;var _global = globalScope;_global.assert = function (condition) {};var NumberWrapper = function () {
    function NumberWrapper() {}return NumberWrapper.parseIntAutoRadix = function (text) {
    ...
    function Location(platformStrategy) {
      ...
      return void 0 === onThrow && (onThrow = null), void 0 === onReturn && (onReturn = null), this._subject.subscribe({ next: onNext, error: onThrow, complete: onReturn });
    ...
    function HashLocationStrategy(_platformLocation, _baseHref) {
      ...
      void 0 === includeHash && (includeHash = !1);var path = this._platformLocation.hash;return isPresent(path) || (path = "#"), path.length > 0 ? path.substring(1) : path;
    ...
    }, HashLocationStrategy.decorators = [{ type: _angular_core.Injectable }], HashLocationStrategy.ctorParameters = function () {
    ...
    function PathLocationStrategy(_platformLocation, href) {
      if (_super.call(this), this._platformLocation = _platformLocation, isBlank(href) && (href = this._platformLocation.getBaseHrefFromDOM()), isBlank(href)) throw new Error("No base href set. Please provide a value for the APP_BASE_HREF token or add a base element to the document.");this._baseHref = href;
    }return __extends$1(PathLocationStrategy, _super), PathLocationStrategy.prototype.onPopState = function (fn) {
      this._platformLocation.onPopState(fn), this._platformLocation.onHashChange(fn);
      ...
      this._platformLocation.back();
    }, PathLocationStrategy.decorators = [{ type: _angular_core.Injectable }], PathLocationStrategy.ctorParameters = function () {
      return [{ type: PlatformLocation }, { type: void 0, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.Inject, args: [APP_BASE_HREF] }] }];
    ...
    function NgLocaleLocalization(_locale) {
      _super.call(this), this._locale = _locale;
    }return __extends$2(NgLocaleLocalization, _super), NgLocaleLocalization.prototype.getPluralCategory = function (value) {
      var plural = getPluralCase(this._locale, value);switch (plural) {case Plural.Zero:
          ...
          return "many";default:
          return "other";}
    }, NgLocaleLocalization.decorators = [{ type: _angular_core.Injectable }], NgLocaleLocalization.ctorParameters = function () {
      return [{ type: void 0, decorators: [{ type: _angular_core.Inject, args: [_angular_core.LOCALE_ID] }] }];
    }, NgLocaleLocalization;
  }(NgLocalization),
      Plural = {};Plural.Zero = 0, Plural.One = 1, Plural.Two = 2, Plural.Few = 3, Plural.Many = 4, Plural.Other = 5, Plural[Plural.Zero] = "Zero", Plural[Plural.One] = "One", Plural[Plural.Two] = "Two", Plural[Plural.Few] = "Few", Plural[Plural.Many] = "Many", Plural[Plural.Other] = "Other";var NgClass = function () {
    function NgClass(_iterableDiffers, _keyValueDiffers, _ngEl, _renderer) {
    ...
    }return Object.defineProperty(NgClass.prototype, "klass", { set: function set(v) {
      ...
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgClass.prototype, "ngClass", { set: function set(v) {
      ...
      if (this._iterableDiffer) {
        var changes = this._iterableDiffer.diff(this._rawClass);changes && this._applyIterableChanges(changes);
      } else if (this._keyValueDiffer) {
        var changes = this._keyValueDiffer.diff(this._rawClass);changes && this._applyKeyValueChanges(changes);
      }
      ...
      var _this = this;changes.forEachAddedItem(function (record) {
        if ("string" != typeof record.item) throw new Error("NgClass can only toggle CSS classes expressed as strings, got " + stringify(record.item));_this._toggleClass(record.item, !0);
      }), changes.forEachRemovedItem(function (record) {
      ...
      var _this = this;rawClassVal && (Array.isArray(rawClassVal) || rawClassVal instanceof Set ? rawClassVal.forEach(function (klass) {
        ...
        isPresent(rawClassVal[klass]) && _this._toggleClass(klass, !isCleanup);
      }));
    ...
    }, NgClass.propDecorators = { klass: [{ type: _angular_core.Input, args: ["class"] }], ngClass: [{ type: _angular_core.Input }] }, NgClass;
  }(),
      NgForRow = function () {
    function NgForRow($implicit, index, count) {
      this.$implicit = $implicit, this.index = index, this.count = count;
    }return Object.defineProperty(NgForRow.prototype, "first", { get: function get() {
        return 0 === this.index;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgForRow.prototype, "last", { get: function get() {
        return this.index === this.count - 1;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgForRow.prototype, "even", { get: function get() {
        return this.index % 2 === 0;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgForRow.prototype, "odd", { get: function get() {
        return !this.even;
      }, enumerable: !0, configurable: !0 }), NgForRow;
  }(),
      NgFor = function () {
    function NgFor(_viewContainer, _template, _differs, _cdr) {
      this._viewContainer = _viewContainer, this._template = _template, this._differs = _differs, this._cdr = _cdr, this._differ = null;
    }return Object.defineProperty(NgFor.prototype, "ngForTrackBy", { get: function get() {
        return this._trackByFn;
      }, set: function set(fn) {
        if ("function" != typeof fn) throw new Error("trackBy must be a function, but received " + JSON.stringify(fn));this._trackByFn = fn;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgFor.prototype, "ngForTemplate", { set: function set(value) {
        value && (this._template = value);
      }, enumerable: !0, configurable: !0 }), NgFor.prototype.ngOnChanges = function (changes) {
    ...
    }, NgFor.decorators = [{ type: _angular_core.Directive, args: [{ selector: "[ngFor][ngForOf]" }] }], NgFor.ctorParameters = function () {
    ...
    }, NgFor.propDecorators = { ngForOf: [{ type: _angular_core.Input }], ngForTrackBy: [{ type: _angular_core.Input }], ngForTemplate: [{ type: _angular_core.Input }] }, NgFor;
  }(),
    ...
    function NgIf(_viewContainer, _template) {
      this._viewContainer = _viewContainer, this._template = _template, this._hasView = !1;
    }return Object.defineProperty(NgIf.prototype, "ngIf", { set: function set(condition) {
        condition && !this._hasView ? (this._hasView = !0, this._viewContainer.createEmbeddedView(this._template)) : !condition && this._hasView && (this._hasView = !1, this._viewContainer.clear());
      }, enumerable: !0, configurable: !0 }), NgIf.decorators = [{ type: _angular_core.Directive, args: [{ selector: "[ngIf]" }] }], NgIf.ctorParameters = function () {
      return [{ type: _angular_core.ViewContainerRef }, { type: _angular_core.TemplateRef }];
    }, NgIf.propDecorators = { ngIf: [{ type: _angular_core.Input }] }, NgIf;
  }(),
      SwitchView = function () {
    ...
    function NgSwitch() {
    ...
    }return Object.defineProperty(NgSwitch.prototype, "ngSwitch", { set: function set(newValue) {
      ...
      return [];
    }, NgSwitch.propDecorators = { ngSwitch: [{ type: _angular_core.Input }] }, NgSwitch;
  }(),
    ...
    }, NgSwitchCase.propDecorators = { ngSwitchCase: [{ type: _angular_core.Input }] }, NgSwitchCase;
  }(),
      NgSwitchDefault = function () {
    function NgSwitchDefault(viewContainer, templateRef, ngSwitch) {
      ngSwitch._addDefault(new SwitchView(viewContainer, templateRef));
    }return NgSwitchDefault.decorators = [{ type: _angular_core.Directive, args: [{ selector: "[ngSwitchDefault]" }] }], NgSwitchDefault.ctorParameters = function () {
      return [{ type: _angular_core.ViewContainerRef }, { type: _angular_core.TemplateRef }, { type: NgSwitch, decorators: [{ type: _angular_core.Host }] }];
    }, NgSwitchDefault;
  }(),
      NgPlural = function () {
    ...
    }return Object.defineProperty(NgPlural.prototype, "ngPlural", { set: function set(value) {
    ...
    }, NgPlural.propDecorators = { ngPlural: [{ type: _angular_core.Input }] }, NgPlural;
  }(),
      NgPluralCase = function () {
    function NgPluralCase(value, template, viewContainer, ngPlural) {
      this.value = value, ngPlural.addCase(value, new SwitchView(viewContainer, template));
    }return NgPluralCase.decorators = [{ type: _angular_core.Directive, args: [{ selector: "[ngPluralCase]" }] }], NgPluralCase.ctorParameters = function () {
    ...
    function NgStyle(_differs, _ngEl, _renderer) {
    ...
    }return Object.defineProperty(NgStyle.prototype, "ngStyle", { set: function set(v) {
        this._ngStyle = v, !this._differ && v && (this._differ = this._differs.find(v).create(null));
      ...
      var _a = nameAndUnit.split("."),
          name = _a[0],
          unit = _a[1];value = value && unit ? "" + value + unit : value, this._renderer.setElementStyle(this._ngEl.nativeElement, name, value);
    ...
    }, NgStyle.propDecorators = { ngStyle: [{ type: _angular_core.Input }] }, NgStyle;
  }(),
      NgTemplateOutlet = function () {
    function NgTemplateOutlet(_viewContainerRef) {
      this._viewContainerRef = _viewContainerRef;
    }return Object.defineProperty(NgTemplateOutlet.prototype, "ngOutletContext", { set: function set(context) {
        this._context = context;
      }, enumerable: !0, configurable: !0 }), Object.defineProperty(NgTemplateOutlet.prototype, "ngTemplateOutlet", { set: function set(templateRef) {
    ...
    }, NgTemplateOutlet.propDecorators = { ngOutletContext: [{ type: _angular_core.Input }], ngTemplateOutlet: [{ type: _angular_core.Input }] }, NgTemplateOutlet;
  }(),
    ...
    function BaseError(message) {
    ...
    }return __extends$4(BaseError, _super), Object.defineProperty(BaseError.prototype, "message", { get: function get() {
      ...
      __extends$3 = (function (_super) {
    function WrappedError(message, error) {
      _super.call(this, message + " caused by: " + (error instanceof Error ? error.message : error)), this.originalError = error;
    }return __extends$4(WrappedError, _super), Object.defineProperty(WrappedError.prototype, "stack", { get: function get() {
    ...
    }return __extends$3(InvalidPipeArgumentError, _super), InvalidPipeArgumentError;
  }(BaseError),
    ...
    function AsyncPipe(_ref) {
      ...
      if (isPromise(obj)) return _promiseStrategy;if (obj.subscribe) return _observableStrategy;throw new InvalidPipeArgumentError(AsyncPipe, obj);
      ...
      NumberFormatStyle = {};NumberFormatStyle.Decimal = 0, NumberFormatStyle.Percent = 1, NumberFormatStyle.Currency = 2, NumberFormatStyle[NumberFormatStyle.Decimal] = "Decimal", NumberFormatStyle[NumberFormatStyle.Percent] = "Percent", NumberFormatStyle[NumberFormatStyle.Currency] = "Currency";var NumberFormatter = function () {
    ...
    function DatePipe(_locale) {
      ...
      void 0 === pattern && (pattern = "mediumDate");var date;if (isBlank$1(value)) return null;if ("string" == typeof value && (value = value.trim()), isDate(value)) date = value;else if (NumberWrapper.isNumeric(value)) date = new Date(parseFloat(value));else if ("string" == typeof value && /^(\d{4}-\d{1,2}-\d{1,2})$/.test(value)) {
      ...
      } else date = new Date(value);if (!isDate(date)) throw new InvalidPipeArgumentError(DatePipe, value);return DateFormatter.format(date, this._locale, DatePipe._ALIASES[pattern] || pattern);
    ...
    function I18nPluralPipe(_localization) {
      ...
      if (isBlank(value)) return "";if ("object" != (typeof pluralMap === "undefined" ? "undefined" : _typeof(pluralMap)) || null === pluralMap) throw new InvalidPipeArgumentError(I18nPluralPipe, pluralMap);var key = getPluralCategory(value, Object.keys(pluralMap), this._localization);return pluralMap[key].replace(_INTERPOLATION_REGEXP, value.toString());
    ...
    function I18nSelectPipe() {}return I18nSelectPipe.prototype.transform = function (value, mapping) {
      if (null == value) return "";if ("object" != (typeof mapping === "undefined" ? "undefined" : _typeof(mapping)) || "string" != typeof value) throw new InvalidPipeArgumentError(I18nSelectPipe, mapping);return mapping.hasOwnProperty(value) ? mapping[value] : mapping.hasOwnProperty("other") ? mapping.other : "";
    ...
    function LowerCasePipe() {}return LowerCasePipe.prototype.transform = function (value) {
      if (isBlank(value)) return value;if ("string" != typeof value) throw new InvalidPipeArgumentError(LowerCasePipe, value);return value.toLowerCase();
    ...
    function DecimalPipe(_locale) {
      ...
      return void 0 === digits && (digits = null), formatNumber(DecimalPipe, this._locale, value, NumberFormatStyle.Decimal, digits);
    ...
    function PercentPipe(_locale) {
      ...
      return void 0 === digits && (digits = null), formatNumber(PercentPipe, this._locale, value, NumberFormatStyle.Percent, digits);
    ...
    function CurrencyPipe(_locale) {
      ...
      return void 0 === currencyCode && (currencyCode = "USD"), void 0 === symbolDisplay && (symbolDisplay = !1), void 0 === digits && (digits = null), formatNumber(CurrencyPipe, this._locale, value, NumberFormatStyle.Currency, digits, currencyCode, symbolDisplay);
    ...
    function SlicePipe() {}return SlicePipe.prototype.transform = function (value, start, end) {
      if (isBlank(value)) return value;if (!this.supports(value)) throw new InvalidPipeArgumentError(SlicePipe, value);return value.slice(start, end);
    ...
    function UpperCasePipe() {}return UpperCasePipe.prototype.transform = function (value) {
      if (isBlank(value)) return value;if ("string" != typeof value) throw new InvalidPipeArgumentError(UpperCasePipe, value);return value.toUpperCase();
